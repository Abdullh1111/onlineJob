...
export function TinCertificateZeroForm({name} : {name:string}) {
const form = useForm()
  ...
  return (
    <div className="my-10">
      ...
      <form  onSubmit={form.handleSubmit(onsubmit)} className="space-y-8">
        <FormItems form={form} label="টনি নম্বর:"></FormItems>
        <FormItems form={form} label="নামঃ"></FormItems>
        <FormItems form={form} label="হোটার আইবি কাররি নাম্বার"></FormItems>
        <FormItems form={form} label="OTP নাম্বারঃ"></FormItems>
        <FormItems form={form} label="বাৎসরিক আয়:"></FormItems>
        <FormItems form={form} label="মোট  সম্পদ:"></FormItems>
